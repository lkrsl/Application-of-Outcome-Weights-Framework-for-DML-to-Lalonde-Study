...
description: |
  ...
  LaLonde–Calónico–Smith (LCS) samples.
link-citations: yes
...
It further applies placebo tests and sensitivity analysis to assess the robustness of the treatment effect estimates. 
The analysis draws on the original LaLonde data (NSW) as well as the LaLonde–Dehejia–Wahba (LDW) and LaLonde–Calónico–Smith (LCS) samples.
...
Section 4 analyzes the original LaLonde data following similar methods and 
section 5 explores the LaLonde-Calónico-Smith (LCS) sample, focusing on female samples.