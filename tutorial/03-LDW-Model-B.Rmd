...
```{r, class.source = "fold-show", fig.cap='FIGURE B2. SubfigureD:LDW-CPS1-PLUS. SubfigureE:LDW-PSID1-PLUS.', out.width='80%', fig.asp=1, fig.align='center'}
#| code-fold: show
# assess overlap
...
### Covariate balance
```{r, class.source = "fold-show", fig.cap='FIGURE B3. SubfigureA:LDW-CPS1. SubfigureB:LDW-CPS1-PLUS. SubfigureC:LDW-PSID1. SubfigureD:LDW-PSID1-PLUS.', out.width='80%', fig.asp=1, fig.align='center'}
...
```{r, class.source = "fold-show", fig.cap='FIGURE B8.'}
#| code-fold: show
# visualize covariate balance
...
```{r, message=FALSE, warning=FALSE, class.source = "fold-show", fig.cap='FIGURE B10.'} 
# visualize covariate balance
...
For LDW-CPS1, the top-ranked samples are based on the same methods as in model A. However, for the LDW-PSID1, the top-ranked samples are based on different methods in two instances.
