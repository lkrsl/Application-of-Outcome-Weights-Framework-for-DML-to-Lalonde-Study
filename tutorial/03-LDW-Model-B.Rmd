...
Top-ranked PSID1 subsamples, on the other hand, again yield more negative mean CATTs and wider ranges compared to their CPS1 counterparts, signaling persistent difficulties in generating robust treatment effect estimates. Still, compared to model A, the minimum CATT values are less strongly negative, though the mean CATTs only improve marginally in their proximity to the experimental benchmark.
