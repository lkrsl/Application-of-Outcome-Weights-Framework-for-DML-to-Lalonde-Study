...
# loop over valid datasets and plot results
...
# save results
save_balance(all_datasets, all_plot_titles, balance_var = "re75", prefix = "ldw_model_b_balance_panels_75")
save_balance(all_datasets, all_plot_titles, balance_var = "re74", prefix = "ldw_model_b_balance_panels_74")
```
