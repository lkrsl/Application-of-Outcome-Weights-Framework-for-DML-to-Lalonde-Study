...
# LaLonde (NSW) Data 
This section (4) examines the effect of the treatment (participation in the job training program) on the participants’ earnings in 1978 (`re78`) in the original LaLonde dataset (loaded as `nsw` below, similar to Imbens & Xu). 
...
```{r, warning=FALSE}
# save results
save_qtet(prefix = "nsw", ylim = c(-25000, 15000))
