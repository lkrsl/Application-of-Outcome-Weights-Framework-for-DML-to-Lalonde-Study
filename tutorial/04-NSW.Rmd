...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE C12. QTET Estimates using NSW Data: Experimental vs. Nonexperimental"}
#| code-fold: show
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE B13. Outcome Weights using NSW Data"}
#| code-fold: show
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE C13. Sensitivity Analyses NSW"}
#| code-fold: show
