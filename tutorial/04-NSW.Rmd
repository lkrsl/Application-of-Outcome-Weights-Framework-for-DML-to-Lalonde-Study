...
#| code-fold: show
# visualize covariate balance
plot_truncation_methods(trunc.cps_plus, "treat", covar, weight_columns, "NSW-CPS1-PLUS")
plot_truncation_methods(trunc.psid_plus, "treat", covar, weight_columns, "NSW-PSID1-PLUS")
```
...
```{r, message=FALSE, warning=FALSE}
# save results 
save_csv(all_cps_plus, "NSW_CPS1_PLUS_all_results")
save_csv(all_psid_plus, "NSW_PSID1_PLUS_all_results")
```
...
dataset_list_cps <- list(
  ...
  ## Truncation
  "fix_max_value_trunc.cps_plus_ebal_weight" = nsw_cps_plus.fixed,
  "fix_max_value_trunc.cps_plus_ipw_weight" = nsw_cps_plus.fixed,
  "fix_max_value_trunc.cps_plus_opt_weight" = nsw_cps_plus.fixed,
  "fix_max_value_trunc.cps_plus_overlap_weight" = nsw_cps_plus.fixed,
  "fix_max_value_trunc.cps_plus_smr_weight" = nsw_cps_plus.fixed,
  "at_perc_trunc.cps_plus_ebal_weight" = nsw_cps_plus.percent,
  "at_perc_trunc.cps_plus_ipw_weight"  = nsw_cps_plus.percent,
  "at_perc_trunc.cps_plus_opt_weight"  = nsw_cps_plus.percent,
  "at_perc_trunc.cps_plus_overlap_weight" = nsw_cps_plus.percent,
  "at_perc_trunc.cps_plus_smr_weight" = nsw_cps_plus.percent,
  "adap_weight_trunc.cps_plus_ebal_weight" = nsw_cps_plus.adapt,
  "adap_weight_trunc.cps_plus_ipw_weight" = nsw_cps_plus.adapt,
  "adap_weight_trunc.cps_plus_opt_weight" = nsw_cps_plus.adapt,
  "adap_weight_trunc.cps_plus_overlap_weight" = nsw_cps_plus.adapt,
  "adap_weight_trunc.cps_plus_smr_weight" = nsw_cps_plus.adapt,
  ##Trimming
  "ps_threshold" = nsw_cps.trim_match,
  "common_range" = nsw_cps_plus.common,
  "stuermer" = nsw_cps_plus.stuermer,
...
dataset_list_psid <- list(
  ...
  ## Truncation
  "fix_max_value_trunc.psid_plus_ebal_weight" = nsw_psid_plus.fixed,
  "fix_max_value_trunc.psid_plus_ipw_weight" = nsw_psid_plus.fixed,
  "fix_max_value_trunc.psid_plus_opt_weight" = nsw_psid_plus.fixed,
  "fix_max_value_trunc.psid_plus_overlap_weight" = nsw_psid_plus.fixed,
  "fix_max_value_trunc.psid_plus_smr_weight" = nsw_psid_plus.fixed,
  "at_perc_trunc.psid_plus_ebal_weight" = nsw_psid_plus.percent,
  "at_perc_trunc.psid_plus_ipw_weight" = nsw_psid_plus.percent,
  "at_perc_trunc.psid_plus_opt_weight" = nsw_psid_plus.percent,
  "at_perc_trunc.psid_plus_overlap_weight" = nsw_psid_plus.percent,
  "at_perc_trunc.psid_plus_smr_weight" = nsw_psid_plus.percent,
  "adap_weight_trunc.psid_plus_ebal_weight" = nsw_psid_plus.adapt,
  "adap_weight_trunc.psid_plus_ipw_weight" = nsw_psid_plus.adapt,
  "adap_weight_trunc.psid_plus_opt_weight" = nsw_psid_plus.adapt,
  "adap_weight_trunc.psid_plus_overlap_weight" = nsw_psid_plus.adapt,
  "adap_weight_trunc.psid_plus_smr_weight" = nsw_psid_plus.adapt,
  ##Trimming
  "ps_threshold" = nsw_psid.trim_match,
  "common_range" = nsw_psid_plus.common,
  "stuermer" = nsw_psid_plus.stuermer,
