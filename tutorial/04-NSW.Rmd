...
out4 <- estimate_all(nsw_cps.trim, "re78", "treat", covar) 
out5 <- estimate_all(nsw_psid.trim, "re78", "treat", covar)
out6 <- estimate_all(nsw_cps_plus.trim, "re78", "treat", covar) # similar to Imbens & Xu (2024)
out7 <- estimate_all(nsw_psid_plus.trim, "re78", "treat", covar) # similar to Imbens & Xu (2024)
...
qte.nsw_cps_plus.trim <- est_qte(Y, treat, covar, data = nsw_cps_plus.trim) # similar to Imbens & Xu (2024)
qte.nsw_psid_plus.trim <- est_qte(Y, treat, covar, data = nsw_psid_plus.trim) # similar to Imbens & Xu (2024)
```
