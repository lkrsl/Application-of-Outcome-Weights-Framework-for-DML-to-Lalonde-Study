...
```{r, class.source = "fold-show", fig.cap='FIGURE A1. SubfigureD:LDW-CPS1-PLUS. SubfigureE:LDW-PSID1-PLUS.', out.width='80%', fig.asp=1, fig.align='center'}
#| code-fold: show
# assess overlap
...
```{r, class.source = "fold-show", fig.cap='FIGURE A2. SubfigureA:LDW-CPS1. SubfigureB:LDW-CPS1-PLUS. SubfigureC:LDW-PSID1. SubfigureD:LDW-PSID1-PLUS.', out.width='80%', fig.asp=1, fig.align='center'}
...
#### Visuals
```{r, class.source = "fold-show", fig.cap='FIGURE A3.'}
#| code-fold: show
...
```{r, warning=FALSE}
# save results
save_qtet(prefix = "model_a", ylim = c(-25000, 15000))
save_qte_top(qte.top5_cps_plus, qte.top5_cps_plus0, qte.ldw_cps, plot_titles, main_start = 6, ylim = c(-25000, 15000), prefix = "model_a_top")
save_qte_top(qte.top5_psid_plus, qte.top5_psid_plus0, qte.ldw_psid, plot_titles, main_start = 11, ylim = c(-25000, 15000), prefix = "model_a_top")
```
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE A15. Sensitivity Analyses Model A"}
#| code-fold: show
