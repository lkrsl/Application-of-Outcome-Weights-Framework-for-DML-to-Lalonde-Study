...
<a name="covariate-balance-overlap"></a>
...
`summarize_att()` computes summary statistics of the treatment effect estimates. 
```{r class.source = 'fold-hide'}
