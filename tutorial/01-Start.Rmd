...
**Packages**: "data.table", "dplyr", "ebal", "ggplot2", "gridExtra", "highr", "highs" , "MatchIt", "optmatch", "optweight", "quickmatch", "readr", "rgenoud", "tidyr", "tidyverse", "WeightIt"
```{r, message=FALSE, warning=FALSE}
# required packages
packages <- c("data.table", "dplyr", "ebal", "ggplot2", "gridExtra", "highr",  "kableExtra", "MatchIt", "optmatch", "optweight", "quickmatch", "readr", "rgenoud", "tidyr", "tidyverse", "WeightIt"
)
