...
This section (5) examines the LaLonde female samples reconstructed by Calónico and Smith (2017), referred to as the LaLonde-Calónico-Smith (LCS) sample (loaded as `lcs` below, similar to @imbens2024). 
...
### Trimming 
#### Propensity score threshold trimming (similar to tutorial of @imbens2024)
```{r}
#| code-fold: show
