...
for (wcol in weight_columns) {
  if (wcol %in% names(nsw_cps_plus)) {
    cps_results[[paste0("cps_", wcol)]] <- check_weights(nsw_cps_plus, wcol)
  } else {
    warning(paste("Column", wcol, "not found in ldw_cps_plus"))
  }
}
...
for (wcol in weight_columns) {
  if (wcol %in% names(nsw_psid_plus)) {
    psid_results[[paste0("psid_", wcol)]] <- check_weights(nsw_psid_plus, wcol)
  } else {
    warning(paste("Column", wcol, "not found in ldw_psid_plus"))
  }
}
...
for (wcol in weight_columns) {
  if (wcol %in% names(lcs_psid_plus)) {
    psid_results[[wcol]] <- check_weights(lcs_psid_plus, wcol)
  } else {
